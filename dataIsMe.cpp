...
bool Land_cstr::GetAttrBool(const std::string& key) const
{
    try {
        ...
        if (v.is_string()) {
            ...
            return (s == "1" || s == "true" || s == "yes" || s == "evet" || s == "var");
        }
    }
    catch (...) {}
    return false;
...
template<> const std::vector<PropertyMap<Land_cstr>>& GetProperties<Land_cstr>() {
    static const std::vector<PropertyMap<Land_cstr>> props = {
        // Kimlik
        { &Land_cstr::Cari_Kod,        _T("Cari_Kod"),        IDC_LAND_CARI_KOD,        _T("Sahibi"),           FT_TEXT,   0,   false },
        { &Land_cstr::Land_Code,       _T("Land_Code"),       IDC_EDIT_LAND_CODE,       _T("Arsa Kodu"),        FT_TEXT,   100, true,  false, { _T("RefNo") } },

        // İlan
        { &Land_cstr::ListingNo,       _T("ListingNo"),       IDC_LAND_LISTING_NO,      _T("İlan No"),          FT_TEXT,   80,  true },
        { &Land_cstr::ListingDate,     _T("ListingDate"),     IDC_LAND_LISTING_DATE,    _T("İlan Tarihi"),      FT_DATE,   90,  true },
        { &Land_cstr::ListingTitle, _T("ListingTitle"), IDC_LAND_LISTING_TITLE, _T("İlan Başlığı"), FT_TEXT, 250, true },
        { &Land_cstr::ListingUrl,   _T("ListingUrl"),   IDC_LAND_LISTING_URL,   _T("Web Adresi"),   FT_TEXT, 350, true, false, { _T("Url"), _T("Web") } },

        { &Land_cstr::PropertyType,    _T("PropertyType"),    IDC_LAND_PROPERTY_TYPE,   _T("Emlak Tipi"),        FT_TEXT,   90,  true },
        { &Land_cstr::SellerType,      _T("SellerType"),      IDC_LAND_SELLER_TYPE,     _T("Kimden"),           FT_TEXT,   90,  true },
        { &Land_cstr::CreditEligible,  _T("CreditEligible"),  IDC_LAND_CREDIT_ELIGIBLE, _T("Kredi"),            FT_TEXT,   60,  false },
        { &Land_cstr::Swap,            _T("Swap"),            IDC_LAND_SWAP,            _T("Takas"),            FT_TEXT,   60,  false },

        // Konum / Tapu
        { &Land_cstr::Adres,           _T("Adres"),           IDC_EDIT_LAND_ADRES,      _T("Adres"),            FT_MEMO,   200, true,  false, { _T("FullAddress") } },
        { &Land_cstr::Lokasyon,        _T("Lokasyon"),        IDC_EDIT_LAND_LOKASYON,   _T("Lokasyon"),         FT_TEXT,   150, true,  false, { _T("District") } },

        { &Land_cstr::Ada,             _T("Ada"),             IDC_EDIT_LAND_ADA,        _T("Ada"),              FT_TEXT,   60,  true },
        { &Land_cstr::Parsel,          _T("Parsel"),          IDC_EDIT_LAND_PARSEL,     _T("Parsel"),           FT_TEXT,   60,  true },
        { &Land_cstr::Pafta,           _T("Pafta"),           IDC_EDIT_LAND_PAFTA,      _T("Pafta"),            FT_TEXT,   60,  false },

        { &Land_cstr::Metrekare,       _T("Metrekare"),       IDC_EDIT_LAND_M2,         _T("m²"),               FT_DOUBLE, 80,  true,  false, { _T("MapArea"), _T("Tapu Alanı (m²)") } },
        { &Land_cstr::PricePerM2,      _T("PricePerM2"),      IDC_LAND_PRICE_PER_M2,    _T("m² Fiyatı"),        FT_DOUBLE, 80,  false },

        { &Land_cstr::ImarDurumu,      _T("ImarDurumu"),      IDC_EDIT_LAND_IMAR,       _T("İmar"),             FT_TEXT,   100, true,  false, { _T("ZoningStatus") } },
        { &Land_cstr::DeedStatus,      _T("DeedStatus"),      IDC_LAND_DEED_STATUS,     _T("Tapu Durumu"),      FT_TEXT,   90,  false, false, { _T("Tapu Durumu") } },
        { &Land_cstr::Kaks,            _T("Kaks"),            IDC_LAND_KAKS,            _T("Kaks (Emsal)"),     FT_TEXT,   80,  false, false, { _T("Kaks (Emsal)") } },
        { &Land_cstr::Gabari,          _T("Gabari"),          IDC_LAND_GABARI,          _T("Gabari"),           FT_TEXT,   70,  false },

        // Finans
        { &Land_cstr::Fiyat,           _T("Fiyat"),           IDC_EDIT_LAND_FIYAT,      _T("Fiyat"),            FT_DOUBLE, 100, true },
        { &Land_cstr::Currency,        _T("Currency"),        IDC_LAND_CURRENCY,        _T("Birim"),            FT_TEXT,   50,  true },

        // Yetki
        { &Land_cstr::YetkiBaslangic,  _T("YetkiBaslangic"),  IDC_LAND_AUTH_START,      _T("Yetki Baş."),       FT_DATE,   0,   false, false, { _T("AuthStart") } },
        { &Land_cstr::YetkiBitis,      _T("YetkiBitis"),      IDC_LAND_AUTH_END,        _T("Yetki Bit."),       FT_DATE,   0,   false, false, { _T("AuthEnd") } },

        // Notlar
        { &Land_cstr::Teklifler,       _T("Teklifler"),       IDC_EDIT_LAND_TEKLIF,     _T("Teklifler"),        FT_MEMO,   0,   false },
        { &Land_cstr::Durum,           _T("Durum"),           IDC_EDIT_LAND_DURUM,      _T("Durum"),            FT_TEXT,   80,  true },
        { &Land_cstr::Status,          _T("Status"),          0,                        _T("Statü"),            FT_TEXT,   80,  false },

        // Ek
        { &Land_cstr::RawKML,          _T("RawKML"),          0,                        _T("KML"),              FT_MEMO,   0,   false },

        // Sistem
        { &Land_cstr::sync_id,         _T("sync_id"),         0,                        _T("Sync ID"),          FT_TEXT,   0,   false },
        { &Land_cstr::Updated_At,      _T("Updated_At"),      0,                        _T("Güncelleme"),       FT_TEXT,   0,   false },
        { &Land_cstr::Deleted,         _T("Deleted"),         0,                        _T("Silindi"),          FT_BOOL,   0,   false },
        { &Land_cstr::Attributes,      _T("Attributes"),      0,                        _T("Özellikler"),       FT_MEMO,   0,   false }
    };
    return props;
}
...
template<> const std::vector<PropertyMap<Villa_cstr>>& GetProperties<Villa_cstr>() {
    static const std::vector<PropertyMap<Villa_cstr>> props = {
        ...
        // --- Kimlik ---
        { &Villa_cstr::Cari_Kod,      _T("Cari_Kod"),      IDC_EDIT_VILLA_CARI_KOD, _T("Cari Kod"),   FT_TEXT,   0,   false },
        { &Villa_cstr::Villa_Code,    _T("Villa_Code"),    IDC_EDIT_VILLA_CODE,     _T("Villa Kodu"), FT_TEXT,   100, true  },

        // --- Web / İlan ---
        { &Villa_cstr::ListingNo,     _T("ListingNo"),     IDC_EDIT_VILLA_LISTING_NO,   _T("İlan No"),     FT_TEXT,  60,  true  },
        { &Villa_cstr::ListingDate,   _T("ListingDate"),   IDC_DTP_VILLA_LISTING_DATE,  _T("İlan Tarihi"), FT_DATE,  0,   true  },
        { &Villa_cstr::WebsiteName,   _T("WebsiteName"),   IDC_EDIT_VILLA_WEBSITE_NAME, _T("Web Site"),    FT_TEXT,  80,  true  },
        { &Villa_cstr::ListingURL,    _T("ListingURL"),    IDC_EDIT_VILLA_LISTING_URL,  _T("Web Adresi"),  FT_TEXT,  250, true  },
        { &Villa_cstr::PropertyType,  _T("PropertyType"),  IDC_COMBO_VILLA_PROPERTY_TYPE,_T("Emlak Tipi"),  FT_TEXT,  120, true  },

        // --- Yetki ---
        { &Villa_cstr::YetkiBaslangic,_T("YetkiBaslangic"),IDC_DTP_VILLA_YETKI_BAS, _T("Yetki Baş."), FT_DATE, 0, false },
        { &Villa_cstr::YetkiBitis,    _T("YetkiBitis"),    IDC_DTP_VILLA_YETKI_BIT, _T("Yetki Bit."), FT_DATE, 0, false },
        ...
        { &Villa_cstr::Ada,           _T("Ada"),           IDC_EDIT_VILLA_ADA,      _T("Ada"),      FT_TEXT,  60,  true  },
        { &Villa_cstr::Parsel,        _T("Parsel"),        IDC_EDIT_VILLA_PARSEL,   _T("Parsel"),   FT_TEXT,  60,  true  },
        { &Villa_cstr::Pafta,         _T("Pafta"),         IDC_EDIT_VILLA_PAFTA,    _T("Pafta"),    FT_TEXT,  60,  false },
        ...
        { &Villa_cstr::AcikAlanM2,    _T("AcikAlanM2"),    IDC_EDIT_VILLA_ACIKALAN, _T("Açık Alan"),FT_DOUBLE, 80,  true  },
        ...
        { &Villa_cstr::Parking,       _T("Parking"),       IDC_COMBO_VILLA_PARKING, _T("Otopark"),  FT_TEXT,   80,  true  },
        { &Villa_cstr::Furnished,     _T("Furnished"),     IDC_COMBO_VILLA_FURNISHED,_T("Eşyalı"),  FT_TEXT,   80,  true  },
        { &Villa_cstr::Swap,          _T("Swap"),          IDC_COMBO_VILLA_SWAP,    _T("Takas"),    FT_TEXT,   80,  true  },

        // --- Fiyat ---
        { &Villa_cstr::Fiyat,         _T("Fiyat"),         IDC_EDIT_VILLA_FIYAT,    _T("Fiyat"),    FT_DOUBLE, 100, true  },
        { &Villa_cstr::Currency,      _T("Currency"),      IDC_COMBO_VILLA_CURRENCY,_T("Birim"),    FT_TEXT,   50,  true  },

        // --- Detay ---
        { &Villa_cstr::BuildingAge,   _T("BuildingAge"),   IDC_COMBO_VILLA_BUILDING_AGE, _T("Bina Yaşı"), FT_TEXT, 80, true },
        { &Villa_cstr::HeatingType,   _T("HeatingType"),   IDC_COMBO_VILLA_HEATING,      _T("Isıtma"),    FT_TEXT, 80, true },
        { &Villa_cstr::BathroomCount, _T("BathroomCount"), IDC_EDIT_VILLA_BATHROOM,      _T("Banyo"),     FT_TEXT, 30, true },
        { &Villa_cstr::KitchenType,   _T("KitchenType"),   IDC_COMBO_VILLA_KITCHEN,      _T("Mutfak"),    FT_TEXT, 80, true },
        { &Villa_cstr::UsageStatus,   _T("UsageStatus"),   IDC_COMBO_VILLA_USAGE,        _T("Kullanım"),  FT_TEXT, 80, true },
        { &Villa_cstr::InSite,        _T("InSite"),        IDC_COMBO_VILLA_INSITE,       _T("Site İçinde"),FT_TEXT,60, true },
        { &Villa_cstr::SiteName,      _T("SiteName"),      IDC_EDIT_VILLA_SITENAME,      _T("Site Adı"),  FT_TEXT, 150,true },
        { &Villa_cstr::Dues,          _T("Dues"),          IDC_EDIT_VILLA_DUES,          _T("Aidat"),     FT_DOUBLE,60, true },
        { &Villa_cstr::CreditEligible,_T("CreditEligible"),IDC_COMBO_VILLA_CREDIT,       _T("Kredi"),     FT_TEXT, 60, true },
        { &Villa_cstr::DeedStatus,    _T("DeedStatus"),    IDC_EDIT_VILLA_DEEDSTATUS,    _T("Tapu"),      FT_TEXT, 110,true },
        { &Villa_cstr::SellerType,    _T("SellerType"),    IDC_COMBO_VILLA_SELLER_TYPE,  _T("Kimden"),    FT_TEXT, 80, true },

        // --- Satıcı ---
        { &Villa_cstr::SellerName,    _T("SellerName"),    IDC_EDIT_VILLA_SELLER_NAME,  _T("Satıcı Ad"),  FT_TEXT, 150, true },
        { &Villa_cstr::SellerPhone,   _T("SellerPhone"),   IDC_EDIT_VILLA_SELLER_PHONE, _T("Satıcı Tel"), FT_TEXT, 110, true },

        // --- Notlar ---
        { &Villa_cstr::Description,   _T("Description"),   IDC_EDIT_VILLA_DESCRIPTION, _T("Açıklama"), FT_MEMO, 0, false },
        { &Villa_cstr::Teklifler,     _T("Teklifler"),     IDC_EDIT_VILLA_TEKLIFLER,   _T("Teklifler"),FT_MEMO, 0, false },
        { &Villa_cstr::Durum,         _T("Durum"),         IDC_EDIT_VILLA_DURUM,       _T("Durum"),    FT_MEMO, 0, false },

        // --- Dialogda kontrolü olmayanlar (şimdilik 0) ---
...
// --- Özellikler (çoklu seçim - JSON array string) ---
{ &Villa_cstr::Facades,              _T("Facades"),              IDC_LV_VILLA_FACADES,       _T("Cephe"),           FT_MEMO, 0, false },
{ &Villa_cstr::FeaturesInterior,     _T("FeaturesInterior"),     IDC_LV_VILLA_INT,           _T("İç Özellikler"),   FT_MEMO, 0, false },
{ &Villa_cstr::FeaturesExterior,     _T("FeaturesExterior"),     IDC_LV_VILLA_EXT,           _T("Dış Özellikler"),  FT_MEMO, 0, false },
{ &Villa_cstr::FeaturesNeighborhood, _T("FeaturesNeighborhood"), IDC_LV_VILLA_NEIGHBOR,      _T("Muhit"),           FT_MEMO, 0, false },
{ &Villa_cstr::FeaturesTransport,    _T("FeaturesTransport"),    IDC_LV_VILLA_TRANSPORT,     _T("Ulaşım"),          FT_MEMO, 0, false },
{ &Villa_cstr::FeaturesView,         _T("FeaturesView"),         IDC_LV_VILLA_VIEW,          _T("Manzara"),         FT_MEMO, 0, false },
{ &Villa_cstr::HousingType,          _T("HousingType"),          IDC_LV_VILLA_HOUSINGTYPE,   _T("Konut Tipi"),      FT_MEMO, 0, false },
{ &Villa_cstr::FeaturesAccessibility,_T("FeaturesAccessibility"),IDC_LV_VILLA_ACCESSIBILITY, _T("Erişilebilirlik"), FT_MEMO, 0, false },
    };
    return props;
}

#pragma once
#ifndef GDI_OFFER_LETTER_LAYOUT_H
#define GDI_OFFER_LETTER_LAYOUT_H
...
class GdiOfferLetterLayout : public IDocumentLayout
{
public:
    GdiOfferLetterLayout() {}
    virtual ~GdiOfferLetterLayout() {}

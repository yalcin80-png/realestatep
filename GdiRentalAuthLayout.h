#pragma once
#ifndef GDI_RENTAL_AUTH_LAYOUT_H
#define GDI_RENTAL_AUTH_LAYOUT_H
...
class GdiRentalAuthLayout : public IDocumentLayout
{
public:
    GdiRentalAuthLayout();
    virtual ~GdiRentalAuthLayout();

    virtual void SetData(const std::vector<std::pair<CString, CString>>& fields) override;
    virtual int  GetTotalPages() const override { return 3; } // 3 Sayfa
